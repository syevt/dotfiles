...
awful.screen.connect_for_each_screen(function(s)
  ...
  s.mywibox:setup {
    ...
    { -- Right widgets
      ...
      logout_menu_widget {
        onlock = function()
          awful.spawn.with_shell 'xlock -fontset "-misc-dejavu serif condensed-medium-i-semicondensed--0-0-0-0-p-0-ascii-0" -mode lisa'
        end,
      },
      s.mylayoutbox,
    },
...
globalkeys = gears.table.join(
  ...
  end, { description = 'select emoji', group = 'launcher' }),
  ...
  awful.key({ modkey, 'Control' }, 'l', function()
    awful.spawn.with_shell 'xlock -fontset "-misc-dejavu serif condensed-medium-i-semicondensed--0-0-0-0-p-0-ascii-0" -mode fiberlamp'
