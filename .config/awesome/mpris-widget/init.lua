...
local PATH_TO_ICONS = "/usr/share/icons/Papirus-Dark/24x24/actions/"
local PAUSE_ICON_NAME = PATH_TO_ICONS .. "player_pause.svg"
local PLAY_ICON_NAME = PATH_TO_ICONS .. "player_play.svg"
local STOP_ICON_NAME = PATH_TO_ICONS .. "player_stop.svg"
local LIBRARY_ICON_NAME = PATH_TO_ICONS .. "music-library.svg"
