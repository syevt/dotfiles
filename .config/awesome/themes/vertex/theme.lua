...
local math, string, tag, tonumber, type, os =
  math, string, tag, tonumber, type, os
local my_table = awful.util.table or gears.table -- 4.{0,1} compatibility

local theme = {}
theme.default_dir = require('awful.util').get_themes_dir() .. 'default'
-- theme.default_dir                               = os.getenv("HOME") .. "/.config/awesome/themes/vertex"
...
-- theme.wallpaper                                 = os.getenv("HOME") .. "/Downloads/1651241224368.jpg"
-- theme.wallpaper                                 = os.getenv("HOME") .. "/Downloads/835adbf9e005231e05a32350b428bd3f.jpg"
...
theme.titlebar_close_button_normal = theme.icon_dir
  .. '/titlebar/close_normal.png'
theme.titlebar_close_button_focus = theme.icon_dir
  .. '/titlebar/close_focus.png'
theme.titlebar_minimize_button_normal = theme.icon_dir
  .. '/titlebar/minimize_normal.png'
theme.titlebar_minimize_button_focus = theme.icon_dir
  .. '/titlebar/minimize_focus.png'
theme.titlebar_ontop_button_normal_inactive = theme.icon_dir
  .. '/titlebar/ontop_normal_inactive.png'
theme.titlebar_ontop_button_focus_inactive = theme.icon_dir
  .. '/titlebar/ontop_focus_inactive.png'
theme.titlebar_ontop_button_normal_active = theme.icon_dir
  .. '/titlebar/ontop_normal_active.png'
theme.titlebar_ontop_button_focus_active = theme.icon_dir
  .. '/titlebar/ontop_focus_active.png'
theme.titlebar_sticky_button_normal_inactive = theme.icon_dir
  .. '/titlebar/sticky_normal_inactive.png'
theme.titlebar_sticky_button_focus_inactive = theme.icon_dir
  .. '/titlebar/sticky_focus_inactive.png'
theme.titlebar_sticky_button_normal_active = theme.icon_dir
  .. '/titlebar/sticky_normal_active.png'
theme.titlebar_sticky_button_focus_active = theme.icon_dir
  .. '/titlebar/sticky_focus_active.png'
theme.titlebar_floating_button_normal_inactive = theme.icon_dir
  .. '/titlebar/floating_normal_inactive.png'
theme.titlebar_floating_button_focus_inactive = theme.icon_dir
  .. '/titlebar/floating_focus_inactive.png'
theme.titlebar_floating_button_normal_active = theme.icon_dir
  .. '/titlebar/floating_normal_active.png'
theme.titlebar_floating_button_focus_active = theme.icon_dir
  .. '/titlebar/floating_focus_active.png'
theme.titlebar_maximized_button_normal_inactive = theme.icon_dir
  .. '/titlebar/maximized_normal_inactive.png'
theme.titlebar_maximized_button_focus_inactive = theme.icon_dir
  .. '/titlebar/maximized_focus_inactive.png'
theme.titlebar_maximized_button_normal_active = theme.icon_dir
  .. '/titlebar/maximized_normal_active.png'
theme.titlebar_maximized_button_focus_active = theme.icon_dir
...
theme.mpd = lain.widget.mpd {
  ...
  settings = function()
    ...
    widget:set_markup(
      markup.font(theme.font, title .. markup(theme.fg_focus, artist))
    )
  end,
}
...
function theme.at_screen_connect(s)
  ...
  s.layoutb =
    wibox.container.margin(s.mylayoutbox, dpi(8), dpi(11), dpi(3), dpi(3))
